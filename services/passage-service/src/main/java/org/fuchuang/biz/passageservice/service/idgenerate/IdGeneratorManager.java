package org.fuchuang.biz.passageservice.service.idgenerate;
...
public final class IdGeneratorManager implements InitializingBean {
    ...
    public static String generateId(long userId) {
        return DISTRIBUTED_ID_GENERATOR.generatedId() + String.valueOf(userId % 1000000);
    }
    ...
    public void afterPropertiesSet() throws Exception {
        ...
        try {
            ...
            long incremented = Optional.ofNullable(
                    instance.opsForValue().increment(DISTRIBUTED_ID_GENERATOR_KEY)
                    )
                    .orElse(0L);
