package org.fuchuang.framework.starter.log.core;
...
public class ILogPrintAspect {
     ...
     */
    // 环绕通知
    @Around("@within(org.fuchuang.framework.starter.log.annotation.ILog) || @annotation(org.fuchuang.framework.starter.log.annotation.ILog)")
