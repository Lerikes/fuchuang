package org.fuchuang.framework.starter.cache.config;

import org.fuchuang.framework.starter.cache.RedisKeySerializer;
import org.fuchuang.framework.starter.cache.StringRedisTemplateProxy;
...
public class CacheAutoConfiguration {
     ...
     * @param bloomFilterPenetrateProperties 布隆过滤器配置
     * @return 布隆过滤器
     */
    @Bean
     ...
     * @param redisKeySerializer redis序列化
