package org.fuchuang.framework.starter.idempotent.config;

import org.fuchuang.framework.starter.cache.DistributedCache;
import org.fuchuang.framework.starter.idempotent.core.IdempotentAspect;
import org.fuchuang.framework.starter.idempotent.core.param.IdempotentParamExecuteHandler;
import org.fuchuang.framework.starter.idempotent.core.param.IdempotentParamService;
import org.fuchuang.framework.starter.idempotent.core.spel.IdempotentSpEByRestAPIExecuteHandler;
import org.fuchuang.framework.starter.idempotent.core.spel.IdempotentSpELByMQExecuteHandler;
import org.fuchuang.framework.starter.idempotent.core.spel.IdempotentSpELService;
import org.fuchuang.framework.starter.idempotent.core.token.IdempotentTokenController;
import org.fuchuang.framework.starter.idempotent.core.token.IdempotentTokenExecuteHandler;
import org.fuchuang.framework.starter.idempotent.core.token.IdempotentTokenService;
...
public class IdempotentAutoConfiguration {
    ...
    public IdempotentSpELService idempotentSpELByRestAPIExecuteHandler(RedissonClient redissonClient) {
        return new IdempotentSpEByRestAPIExecuteHandler(redissonClient);
    }
